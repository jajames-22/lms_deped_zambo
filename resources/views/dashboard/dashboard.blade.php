                ...
                <div class="flex-shrink-0">
                    <a href="{{ url('/dashboard') }}">
                        <img src="{{ asset('storage/images/lms-logo-red.png') }}" 
                             class="w-48 h-auto object-contain block" 
                             alt="LMS Logo">
                    </a>
                </div>
            ...
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 md:px-8 shrink-0 sticky top-0 z-20">
                <div class="flex items-center gap-4 flex-1">
                    ...
                    <div class="flex items-center bg-gray-100 px-3 py-2 rounded-lg w-full max-w-md hidden sm:flex border border-transparent focus-within:border-[#a52a2a]/30 transition">
                        ...
                        <input type="text" placeholder="Search courses, lessons..." class="bg-transparent border-none outline-none text-sm w-full focus:ring-0">
                    </div>
                </div>
        ...
        <div class="relative flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center transform transition-all border border-gray-100">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ url('/') }}" class="flex-1 px-4 py-2.5 bg-[#a52a2a] text-white font-semibold rounded-xl hover:opacity-90 transition shadow-lg shadow-[#a52a2a]/30 text-sm text-center">
                        Yes, Logout
                    </a>
                </div>
            </div>
