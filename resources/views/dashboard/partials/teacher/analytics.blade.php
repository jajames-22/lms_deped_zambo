    ...
    <div class="fixed bottom-8 right-8 z-50 flex flex-col items-end">
        <div id="fabMenu"
            ...
            <div
                ...
                <button onclick="scrollToSection('material-engagement'); toggleFabMenu();"
                    class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600 hover:text-[#a52a2a] hover:bg-red-50 rounded-xl transition-all text-left">
                    <i class="fas fa-book-open w-4 text-center"></i> Engagement
                </button>
                <button onclick="scrollToSection('assessment-performance'); toggleFabMenu();"
                    class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600 hover:text-[#a52a2a] hover:bg-red-50 rounded-xl transition-all text-left">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-center">
                    <div class="text-center w-full">
                        <h4 class="text-gray-700 font-semibold mb-4 border-b pb-2 text-left">Correct vs Incorrect
                            Answers</h4>
                ...
                <div
                    ...
                    <div
                        class="w-20 h-20 bg-yellow-50 text-yellow-500 rounded-full flex items-center justify-center text-3xl mx-auto mb-4 border-4 border-yellow-100">
                    ...
                    <p class="text-sm text-gray-400 mt-4 px-4">Based on all student responses to Exam embedded in your
                        modules.</p>
                </div>
            </div>
        </section>
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 transition-transform duration-300"
        ...
        <form action="{{ route('analytics.export.teacher') }}" method="GET" target="_blank">
            <div class="space-y-3 mb-6">
                ...
                <label
                    class="flex items-center gap-3 p-3 border border-gray-100 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="check_engagement" checked
                        class="w-5 h-5 text-[#a52a2a] rounded border-gray-300 focus:ring-[#a52a2a]">
...
<script>
    ...
    function initDashboardCharts() {
        ...
        window.dashboardCharts.teacherViews = new Chart(viewsCtx, {
            type: 'bar',
            data: {
        ...
        @if($completedCount > 0 || $inProgressCount > 0)
            ...
            window.dashboardCharts.teacherProgress = new Chart(progressCtx, {
                type: 'doughnut',
                data: {
        ...
        @endif
            ...
            @if($correctAnswers > 0 || $incorrectAnswers > 0)
                ...
                window.dashboardCharts.teacherScores = new Chart(scoresCtx, {
                    type: 'doughnut',
                    data: {
