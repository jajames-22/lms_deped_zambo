            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="middle_name" value="{{ $student->middle_name }}" placeholder="Optional"
                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#a52a2a]/20 focus:border-[#a52a2a] outline-none transition-all text-sm">
                    </div>
                    <div class="space-y-1.5">
                ...
                <div class="space-y-2 pt-4 border-t border-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status" value="pending" class="peer sr-only" {{ $student->status == 'pending' ? 'checked' : '' }}>
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status" value="verified" class="peer sr-only" {{ $student->status == 'verified' ? 'checked' : '' }}>
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status" value="suspended" class="peer sr-only" {{ $student->status == 'suspended' ? 'checked' : '' }}>
