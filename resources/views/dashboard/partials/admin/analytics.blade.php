    ...
    <div class="fixed bottom-8 right-8 z-50 flex flex-col items-end">
        <div id="fabMenu"
            ...
            <div
                ...
                <button onclick="scrollToSection('ui-user-demographics'); toggleFabMenu();"
                ...
                <button onclick="scrollToSection('ui-content-engagement'); toggleFabMenu();"
                    class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600 hover:text-[#a52a2a] hover:bg-red-50 rounded-xl transition-all text-left">
                    <i class="fas fa-book-open w-4 text-center"></i> Content & Engagement
                </button>
                <button onclick="scrollToSection('ui-system-health'); toggleFabMenu();"
                    class="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-600 hover:text-[#a52a2a] hover:bg-red-50 rounded-xl transition-all text-left">
        ...
        <section id="ui-user-demographics" class="scroll-mt-20">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center"><i
                        class="fas fa-users text-lg"></i></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 border-l-4 border-l-indigo-500">
                    <p class="text-gray-500 text-sm font-medium mb-1">Total Teachers</p>
        ...
        <section id="ui-content-engagement" class="scroll-mt-20">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-10 h-10 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center"><i
                        class="fas fa-book-open text-lg"></i></div>
        ...
        <section id="ui-system-health" class="scroll-mt-20">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-10 h-10 rounded-full bg-green-100 text-green-600 flex items-center justify-center"><i
                        class="fas fa-server text-lg"></i></div>
                <h3 class="text-2xl font-bold text-gray-800">System Health & Storage</h3>
            </div>

            <div
                class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="w-full md:w-2/3 space-y-4">
                    <div>
                        ...
                        <div class="w-full bg-gray-100 rounded-full h-3">
                            <div class="h-3 rounded-full {{ $storagePercentage > 85 ? 'bg-red-500' : 'bg-green-500' }}"
                                style="width: {{ $storagePercentage }}%"></div>
                        </div>
                    </div>
                    <p class="text-sm text-gray-500">
                        @if($storagePercentage > 85)
                            <i class="fas fa-exclamation-triangle text-red-500 mr-1"></i> Warning: Storage capacity is
                            running low. Please clear temporary files or upgrade capacity.
                        @else
        ...
        <form action="{{ route('analytics.export.admin') }}" method="GET" target="_blank">
            <div class="space-y-3 mb-6">
                <label
                    ...
                    <input type="checkbox" name="check_users" checked
                ...
                <label
                    class="flex items-center gap-3 p-3 border border-gray-100 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="check_content" checked
                        class="w-5 h-5 text-[#a52a2a] rounded border-gray-300 focus:ring-[#a52a2a]">
                    <span class="text-gray-700 font-medium">Content & Engagement</span>
                </label>
                <label
                    class="flex items-center gap-3 p-3 border border-gray-100 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="check_health" checked
                        class="w-5 h-5 text-[#a52a2a] rounded border-gray-300 focus:ring-[#a52a2a]">
