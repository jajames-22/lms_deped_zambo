...
<body class="bg-gray-50 font-sans text-gray-900 overflow-x-hidden">
    ...
    <nav class="flex-1 space-y-1 mt-4">
        <a href="#" class="flex items-center px-4 py-3 bg-red-50 text-red-700 font-medium border-r-4 border-red-600">
    ...
    <div class="p-4 border-t border-gray-100">
        <button class="w-full flex items-center px-4 py-3 text-red-500 hover:bg-red-50 rounded-lg transition font-medium">
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
            <!-- Header -->
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 md:px-8 shrink-0">
                <div class="flex items-center gap-4 flex-1">
                    ...
                    <div class="flex items-center bg-gray-100 px-3 py-2 rounded-lg w-full max-w-md hidden sm:flex">
                        ...
                        <input type="text" placeholder="Search courses..." class="bg-transparent border-none outline-none text-sm w-full">
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3 border-l pl-4 border-gray-200">
                        <img class="h-9 w-9 rounded-full border-2 border-indigo-100" src="https://ui-avatars.com/api/?name=Alex+Johnson&background=6366f1&color=fff" alt="Profile">
                    </div>
                </div>
            </header>
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-8">
                ...
                <section class="mb-8">
                    ...
                    <p class="text-gray-500 mt-1">You've completed <span class="text-indigo-600 font-semibold">80%</span> of your weekly goal.</p>
                </section>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-blue-100 text-blue-600 rounded-xl"><i class="fas fa-book text-xl"></i></div>
                            <div><p class="text-xs text-gray-500">Enrolled</p><p class="text-xl font-bold">12</p></div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-green-100 text-green-600 rounded-xl"><i class="fas fa-check-circle text-xl"></i></div>
                            <div><p class="text-xs text-gray-500">Completed</p><p class="text-xl font-bold">04</p></div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-yellow-100 text-yellow-600 rounded-xl"><i class="fas fa-clock text-xl"></i></div>
                            <div><p class="text-xs text-gray-500">Hours</p><p class="text-xl font-bold">58h</p></div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-purple-100 text-purple-600 rounded-xl"><i class="fas fa-certificate text-xl"></i></div>
                            <div><p class="text-xs text-gray-500">Badges</p><p class="text-xl font-bold">02</p></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center gap-4">
                            <img src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?w=300" class="w-full sm:w-24 h-24 object-cover rounded-xl" alt="Course">
                            ...
                            <button class="bg-indigo-600 text-white px-4 py-2 rounded-lg text-xs font-semibold hover:bg-indigo-700 w-full sm:w-auto">Continue</button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit">
                        ...
                        <div class="space-y-4 text-sm text-gray-600">
                            <p class="flex items-center"><i class="fas fa-circle text-[8px] text-red-500 mr-2"></i> Final Quiz Today</p>
                            <p class="flex items-center"><i class="fas fa-circle text-[8px] text-gray-300 mr-2"></i> Mar 24: Project Due</p>
                        </div>
                    </div>
                </div>
            </div>
