            ...
            <div class="p-6 text-gray-700">
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="font-bold text-gray-900 text-lg">Sir Salimar B. Tahil, MEnggED ICT</p>
                            <p class="text-sm text-gray-500 font-medium">WMSU-CCS - Project Manager</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-900 text-lg">James Benedict A. Rojas</p>
                            <p class="text-sm text-gray-500 font-medium mt-1">WMSU-CCS Student Intern / Systems Developers</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 font-medium">DepEd - Division of Zamboanga City - ITO III / Project Adviser</p>
                        </div>
                    </div>
                </div>
            </div>
