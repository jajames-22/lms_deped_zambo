...
<body>
    <header style="background-color: #a52a2a;" class="fixed p-1 flex justify-center z-40 w-full items-center">
        <img src="{{ asset('storage/images/deped_zambo_header.png') }}" 
         class="w-full max-w-4xl h-auto block" 
        ...
        >
            ...
            <div class="relative z-10 max-w-7xl mx-auto text-center flex items-center justify-center flex-col">
                ...
                <div class="mt-7 flex flex-col w-full sm:flex-row gap-3 justify-center">
                    ...
                    <button class="px-8 py-3 bg-white hover:bg-white-100 text-red-700 font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">Create Account</button>
                </div>
            </div>
        </section>
